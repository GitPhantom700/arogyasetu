...
![Geospatial GIS Command Map](ui_audit_assets/07_geospatial_map.png)
...
![Slide-Over Facility Batch Drawer](ui_audit_assets/06_facility_batch_drawer.png)
...
![Consolidated Facility Inventory Grid](ui_audit_assets/05_facility_stocks_en.png)
...
![Facility Stocks (मराठी)](ui_audit_assets/19_facility_stocks_mr.png)
...
![AI Rebalancing Cockpit](ui_audit_assets/08_ai_rebalancer.png)
...
![Generated Rebalancing Plan Details](ui_audit_assets/09_ai_rebalance_plan.png)
...
![Doctor HITL Authorization Sign-Off Modal](ui_audit_assets/21_rebalance_authorization_modal.png)
...
![Deterministic AI Safety Firewall Verification](ui_audit_assets/16_ai_safety_modal.png)
...
![Inter-Facility Transfers Management](ui_audit_assets/03_transfers_en.png)
...
![Inter-Facility Transfers (मराठी)](ui_audit_assets/04_transfers_mr.png)
...
![Expanded Cryptographic Custody Trail](ui_audit_assets/20_transfer_crypto_trail_expanded.png)
...
![DSCSA Cryptographic Ledger Explorer](ui_audit_assets/10_dscsa_block_ledger.png)
...
![Field Staff Rapid Dispensing Interface](ui_audit_assets/11_field_portal_quick_logger.png)
...
![Hands-Free Multilingual Voice Dictation Modal](ui_audit_assets/22_voice_dictation_modal.png)
...
![Offline Resilience and IndexedDB Queue Sync](ui_audit_assets/25_offline_mode_drill.png)
...
![Paper Register Photo Intake](ui_audit_assets/12_gemini_vision_ocr_intake.png)
...
![Gemini 3.6 Flash Vision Digitized Register Table](ui_audit_assets/13_ocr_extracted_register.png)
...
![Crisis Simulator Baseline State](ui_audit_assets/14_crisis_simulator_baseline.png)
...
![Emergency Shock Active and Automated Swarm Dispatch](ui_audit_assets/15_crisis_shock_active.png)
