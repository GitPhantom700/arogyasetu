...
- **15 Simulated PHCs:** Realistic health network across Pune and Satara districts (Western Ghats) seeded with 183 critical medicine batches.
...
- **Gemini 2.5 Flash Vision OCR:** Physical paper register and invoice digitization (`/api/inventory/scan-register`) with `RapidFuzz` clinical catalog disambiguation and mandatory pharmacist-in-the-loop review.
